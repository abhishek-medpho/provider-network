...
const sharedAttributes: AttributeSeed[] = [
  ...
  },
  {
    ...
    category: "geography",
    helpText:
      "Tap below to share where you are right now. You can update this later when you're at home.",
    piiLevel: PiiLevel.MEDIUM,
  ...
  },
  {
    ...
    type: AttributeType.SINGLE_SELECT,
    category: "geography",
    helpText: "We'll match you to jobs within this radius of your home pincode.",
    options: [
      { value: "5", label: "Up to 5 km" },
      { value: "10", label: "Up to 10 km" },
      { value: "15", label: "Up to 15 km" },
      { value: "25", label: "Up to 25 km" },
      { value: "50", label: "50+ km (anywhere)" },
    ],
    validation: { required: true },
    isSearchable: true,
  },
  {
    ...
    type: AttributeType.FILE_IMAGE,
    category: "verification",
    helpText: "Photo of the front of your Aadhaar card.",
    piiLevel: PiiLevel.HIGH,
    validation: { required: true, fileMaxKb: 5120 },
  },
  {
    key: "aadhaar_back",
    ...
    type: AttributeType.FILE_IMAGE,
    category: "verification",
    helpText: "Photo of the back of your Aadhaar card.",
    piiLevel: PiiLevel.HIGH,
    validation: { required: true, fileMaxKb: 5120 },
  },
  {
    ...
    type: AttributeType.FILE_IMAGE,
    category: "verification",
    helpText: "Photo or PDF of your highest qualification certificate.",
    piiLevel: PiiLevel.MEDIUM,
    validation: { required: true, fileMaxKb: 5120 },
  },
  // --- Languages ---
